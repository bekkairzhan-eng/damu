...
> Все эндпоинты требуют роль `hr`. HR видит только сотрудников своего скоупа — см. [HRD_QUESTIONS.md](HRD_QUESTIONS.md#доступы-и-роли), вопрос №15. Эндпоинты по заявкам на обучение и сертификатам — см. раздел 5.7 выше.
...
⚠️ Формат запроса к LMS — открытый вопрос, см. [HRD_QUESTIONS.md](HRD_QUESTIONS.md#интеграции-и-технические-контракты), вопрос №21. Зафиксировать с командой BPM/LMS (см. [BPM_INTEGRATION.md](BPM_INTEGRATION.md#3-заявка-на-обучение)).
