...
const SKILLS_BY_TARGET = {
  'Foreman A': [
    'Чтение строительных чертежей', 'Контроль качества строительства', 'Работа с госдокументацией',
    'Нормативная база строительства', 'BIM-технологии (Revit)', 'Управление командой',
    'Управление субподрядчиками', 'Охрана труда и ТБ',
  ],
  'Foreman B': [
    'Чтение строительных чертежей', 'Контроль качества строительства',
    'Управление командой', 'Охрана труда и ТБ', 'Управление строительными рисками',
  ],
  'Site Engineer A': [
    'BIM-технологии (Revit)', 'Нормативная база строительства', 'Цифровые инструменты управления',
    'MS Project', 'Управление командой', 'Охрана труда и ТБ',
  ],
}

const DEFAULT_SKILLS = [
  'Чтение строительных чертежей', 'Контроль качества строительства', 'Управление командой', 'Охрана труда и ТБ',
]
...
const DEFAULT_ASSESSMENT_HISTORY = [
  {
    ...
    skills: [
      ...
      { name: 'Контроль качества строительства', passed: true,  comment: '' },
      { name: 'Работа с госдокументацией',        passed: true,  comment: '' },
      { name: 'BIM-технологии (Revit)',           passed: false, comment: 'Необходимо пройти курс Revit Advanced. Текущий уровень недостаточен для перехода на Foreman A.' },
      ...
      { name: 'Охрана труда и ТБ',                passed: true,  comment: '' },
      { name: 'Нормативная база строительства',   passed: false, comment: 'Обновить знания по СНиП 2025. Пройти курс "Актуальные нормативы в строительстве".' },
    ],
  },
  {
    id: 1,
    ...
    skills: [
      { name: 'Чтение строительных чертежей',    passed: true,  comment: '' },
      { name: 'Контроль качества строительства', passed: false, comment: 'Нет системного подхода. Рекомендую курс по контролю качества ПИР.' },
      { name: 'Управление командой',              passed: false, comment: 'Не хватает навыков мотивации команды. Пройти тренинг по лидерству.' },
      { name: 'Охрана труда и ТБ',                passed: true,  comment: '' },
      { name: 'BIM-технологии (Revit)',           passed: false, comment: 'Базовый уровень недостаточен. Требуется Revit Intermediate.' },
    ],
  },
]
